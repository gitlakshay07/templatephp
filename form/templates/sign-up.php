              ...
              <div class="card-body">
                <form role="form" method="POST" id="signupform">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <label class="error w-100" for="conf_password"></label>
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" id="submitbtn" class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Sign Up</button>
                  </div>
                </form>
              </div>
