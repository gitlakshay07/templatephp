          ...
          <div class="card-body">
            <form role="form" method="post" class="text-start">
              <div class="input-group input-group-outline mb-3">
                ...
                <input type="text" class="form-control" name="otp_val" id="otp">
                <label class="error w-100" for="email"></label>
              </div>
              <div class="text-center">
                <button type="submit" name="otp" value="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Submit</button>
              </div>
            </form>
          </div>
        </div>
